...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 17 mei 2017 om 14:53
-- Serverversie: 5.7.14
-- PHP-versie: 5.6.25
...
--
ALTER TABLE `documenten`
  MODIFY `documentNummer` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `klant`
  MODIFY `klantNummer` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `project`
  MODIFY `projectNummer` int(11) NOT NULL AUTO_INCREMENT;
--
